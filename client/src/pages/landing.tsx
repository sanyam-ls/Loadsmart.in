  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#060817' }}>
      ...
      <section className="py-20 relative" style={{ 
        ...
        <div className="absolute inset-0" style={{ backgroundColor: 'rgba(10, 18, 37, 0.7)' }} />
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="flex justify-around items-center mt-4">
              {features.map((feature, index) => (
                <span key={index} className="text-lg font-bold text-center max-w-[160px]" style={{ 
                  color: activeFeature === index ? '#00BFFF' : '#FFFFFF',
