  ...
  return (
    <div className="min-h-screen bg-[#0d1117]">
      ...
      <header className="sticky top-0 z-50 w-full bg-[#1a1a2e] border-b border-[#1a1a2e]">
        <div className="flex h-16 items-center justify-between w-full px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/auth">
              <Button className="bg-[#3366FF] hover:bg-[#2855CC] text-white" data-testid="button-get-started">
                Get Started
              </Button>
            </Link>
          </div>
      ...
      <section className="relative py-20 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a2e] via-[#0d1117] to-[#1a1a2e]" />
        <div className="relative z-10 container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6" data-testid="text-hero-title">
              LoadSmart <span className="text-[#3366FF]">Load Board</span>
            </h1>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link href="/auth">
                <Button size="lg" className="bg-[#3366FF] hover:bg-[#2855CC] text-white px-8" data-testid="button-post-load">
                  Post a Load
                </Button>
              </Link>
              <Link href="/auth">
                <Button size="lg" variant="outline" className="border-[#3366FF] text-[#3366FF] hover:bg-[#3366FF]/10 px-8" data-testid="button-find-loads">
                  Find Loads
                </Button>
              </Link>
            </div>
      ...
      <section className="py-16 bg-[#161b22]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-[#21262d] rounded-xl p-8 border border-gray-700/50">
      ...
      <section className="py-16 bg-[#0d1117]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <Card className="bg-[#21262d] border-gray-700/50 p-6 hover:border-[#3366FF]/50 transition-colors" data-testid="card-feature-search">
              <div className="w-12 h-12 bg-[#3366FF]/10 rounded-lg flex items-center justify-center mb-4">
                <Search className="w-6 h-6 text-[#3366FF]" />
              </div>
            ...
            {/* Feature 2 */}
            <Card className="bg-[#21262d] border-gray-700/50 p-6 hover:border-[#3366FF]/50 transition-colors" data-testid="card-feature-realtime">
              <div className="w-12 h-12 bg-[#3366FF]/10 rounded-lg flex items-center justify-center mb-4">
                <Clock className="w-6 h-6 text-[#3366FF]" />
              </div>
            ...
            {/* Feature 3 */}
            <Card className="bg-[#21262d] border-gray-700/50 p-6 hover:border-[#3366FF]/50 transition-colors" data-testid="card-feature-verified">
              <div className="w-12 h-12 bg-[#3366FF]/10 rounded-lg flex items-center justify-center mb-4">
            ...
            {/* Feature 4 */}
            <Card className="bg-[#21262d] border-gray-700/50 p-6 hover:border-[#3366FF]/50 transition-colors" data-testid="card-feature-bidding">
              <div className="w-12 h-12 bg-[#3366FF]/10 rounded-lg flex items-center justify-center mb-4">
                <DollarSign className="w-6 h-6 text-[#3366FF]" />
              </div>
            ...
            {/* Feature 5 */}
            <Card className="bg-[#21262d] border-gray-700/50 p-6 hover:border-[#3366FF]/50 transition-colors" data-testid="card-feature-tracking">
              <div className="w-12 h-12 bg-[#3366FF]/10 rounded-lg flex items-center justify-center mb-4">
            ...
            {/* Feature 6 */}
            <Card className="bg-[#21262d] border-gray-700/50 p-6 hover:border-[#3366FF]/50 transition-colors" data-testid="card-feature-analytics">
              <div className="w-12 h-12 bg-[#3366FF]/10 rounded-lg flex items-center justify-center mb-4">
      ...
      <section className="py-16 bg-[#161b22]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            {/* For Shippers */}
            <div className="bg-[#21262d] rounded-xl p-8 border border-gray-700/50">
              <h3 className="text-2xl font-bold text-[#3366FF] mb-6">For Shippers</h3>
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-8 h-8 bg-[#3366FF] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">1</div>
                  <div>
                    <h4 className="text-white font-semibold mb-1">Post Your Load</h4>
                    <p className="text-gray-400 text-sm">Enter pickup/delivery locations, cargo details, and schedule</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-8 h-8 bg-[#3366FF] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">2</div>
                  <div>
                    <h4 className="text-white font-semibold mb-1">Receive Bids</h4>
                    <p className="text-gray-400 text-sm">Verified carriers submit competitive bids for your load</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-8 h-8 bg-[#3366FF] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">3</div>
                  <div>
                    <h4 className="text-white font-semibold mb-1">Select & Track</h4>
                    <p className="text-gray-400 text-sm">Choose the best carrier and track your shipment in real-time</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* For Carriers */}
            <div className="bg-[#21262d] rounded-xl p-8 border border-gray-700/50">
              <h3 className="text-2xl font-bold text-[#3366FF] mb-6">For Carriers</h3>
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-8 h-8 bg-[#3366FF] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">1</div>
                  <div>
                    <h4 className="text-white font-semibold mb-1">Browse Loads</h4>
                    <p className="text-gray-400 text-sm">Search and filter loads by route, weight, and truck type</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-8 h-8 bg-[#3366FF] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">2</div>
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Submit competitive rates or accept fixed-price loads instantly</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-8 h-8 bg-[#3366FF] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">3</div>
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Complete the delivery and receive quick, secure payments</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-[#3366FF]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Truck className="w-8 h-8 text-[#3366FF]" />
              </div>
              <h3 className="text-3xl font-bold text-white mb-2">10,000+</h3>
              <p className="text-gray-400">Active Loads Daily</p>
            </div>
            
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-[#3366FF]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Shield className="w-8 h-8 text-[#3366FF]" />
              </div>
              <h3 className="text-3xl font-bold text-white mb-2">5,000+</h3>
              <p className="text-gray-400">Verified Carriers</p>
            </div>
            
            <div className="text-center p-6">
              <div className="w-16 h-16 bg-[#3366FF]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <MapPin className="w-8 h-8 text-[#3366FF]" />
              </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-400">Avg. Savings</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#3366FF] to-[#2855CC]">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/auth">
              <Button size="lg" className="bg-white text-[#3366FF] hover:bg-gray-100 px-8" data-testid="button-cta-signup">
                Create Free Account
              </Button>
            </Link>
            <Link href="/">
      ...
      {/* Footer */}
      <footer className="bg-[#0d1117] py-8 border-t border-gray-800">
        <div className="container mx-auto px-4 text-center">
